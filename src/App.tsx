  ...
  return (
    <>
      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-32 lg:grid-cols-12 relative z-10">
        ...
        <h1
          ...
          >
            Astitwo{" "}
            <span id="dynamicWords" className="text-red-500 font-bold">
              Pandey
            </span>
          </h1>
          ...
          <a
            href="#about"
            className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text:3xl text-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900"
          >
            More About Me
            <svg
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-5 py-4 text-base font-medium text:3xl text-center text-gray-900 border-4 border-red-300 hover:bg-red-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-red-700 dark:hover:bg-red-700 dark:focus:ring-gray-800"
          >
            Contact Me!
          </a>
        </div>
    ...
    {/* #### ACCOLADES SECTION #### */}
        <section className="bg-white dark:bg-black ">
          <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-28 lg:px-6 border-4 border-solid border-red-700 bg-white dark:bg-black relative z-20">
          <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
              <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-5xl md:text-7xl font-extrabold">
                      <span data-counter-target="50">0</span>+
                  </dt>
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">Assessments</dd>
              </div>
              <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-5xl md:text-7xl font-extrabold">
                      <span data-counter-target="200">0</span>+
                  </dt>
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">Vulnerabilities Found</dd>
              </div>
              <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-5xl md:text-7xl font-extrabold">
                      <span data-counter-target="100">0</span>%
                  </dt>
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">Remediation Rate</dd>
              </div>
          </dl>
                    </div>
        ...
        {/* #### SERVICES SECTION #### */}
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-center">
              ...
              <div className="transform transition-all duration-300 hover:scale-105 group">
                  <div className="flex justify-center mx-auto items-center mb-4 w-10 h-10 rounded-full bg-red-100 lg:h-12 lg:w-12 dark:bg-red-900">
                    <svg
                      className="w-[48px] h-[48px] text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-red-500 group-hover:scale-125"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="transform transition-all duration-300 hover:scale-105 group">
                  <div className="flex justify-center mx-auto items-center mb-4 w-10 h-10 rounded-full bg-red-100 lg:h-12 lg:w-12 dark:bg-red-900">
                  <svg className="w-[48px] h-[48px] text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-red-500 group-hover:scale-125 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <section className="bg-gray-100 dark:bg-black lg:py-18 lg:px-6 border-t-4 border-b-4 border-solid border-red-700 bg-white dark:bg-black relative z-20">
            <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4 ">
                <h2 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Certifications &amp; Credentials</h2>
                <div className="flex flex-wrap justify-center gap-6 items-center text-gray-500 dark:text-gray-400">
                    <span className="text-3xl md:text-4xl font-bold font-mono border-2 border-red-700 px-6 py-3 text-red-500">AWS SAA</span>
                    <span className="text-3xl md:text-4xl font-bold font-mono border-2 border-red-700 px-6 py-3 text-red-500">eJPT</span>
                </div>
            </div>
        </section>
          ...
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-8 lg:px-6">
            <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              I'm Astitwo Pandey — a penetration tester who gets paid to think like an attacker. I've spent years breaking into systems, exploiting misconfigurations, and helping organizations harden their defenses.
              </p>
              <p className="text-xl">
        ...
        <section id="contact-header" className="bg-white dark:bg-black">
